...
# Fungsi backward chaining untuk memeriksa apakah gangguan tertentu cocok dengan gejala yang diberikan
def backward_chaining(evidence):
    hasil = []
    for gangguan in gangguan_data:
        # Mulai dari setiap gangguan dan verifikasi apakah gejala dalam data gangguan tercakup dalam gejala yang diberikan
...
# Panggil fungsi backward_chaining untuk mencari jenis gangguan
diagnosis = backward_chaining(evidence)
